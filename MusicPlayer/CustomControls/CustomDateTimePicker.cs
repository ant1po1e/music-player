...
namespace InventorySystem.Controls
{
    public class CustomDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = pomodoro.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = pomodoro.Properties.Resources.calendarDark;
                else calendarIcon = pomodoro.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
